...
require (
	...
	github.com/open-edge-platform/virtual-edge-node/edge-node-simulator v0.6.4
)
...
require (
	...
	github.com/open-edge-platform/infra-core/apiv2/v2 v2.1.0 // indirect
	github.com/open-edge-platform/infra-onboarding/onboarding-manager v1.36.3 // indirect
