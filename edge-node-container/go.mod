...
require (
	...
	github.com/open-edge-platform/virtual-edge-node/edge-node-simulator v0.6.3
)
...
require (
	...
	github.com/open-edge-platform/infra-core/api v1.34.0 // indirect
	github.com/open-edge-platform/infra-onboarding/onboarding-manager v1.36.2 // indirect
