...
require (
	...
	github.com/open-edge-platform/virtual-edge-node/edge-node-simulator v0.7.4
)
...
require (
	...
	github.com/open-edge-platform/infra-core/apiv2/v2 v2.7.1 // indirect
	github.com/open-edge-platform/infra-onboarding/onboarding-manager v1.38.12 // indirect
